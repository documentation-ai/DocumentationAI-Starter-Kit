...
description: "Complete installation guide for Your SaaS Product including workspace setup, team onboarding, and initial configuration."
---

# Installation & Setup

Get Your SaaS Product properly installed and configured for your team. This guide covers everything from account creation to advanced setup options.

## Overview

Your SaaS Product is a cloud-based platform that requires no software installation on individual devices. However, there are several setup steps to ensure optimal performance and security for your team.
...
1. **Visit the signup page**: [yourapp.com/signup](https://yourapp.com/signup)
...
1. **Contact our sales team**: [yourapp.com/enterprise](https://yourapp.com/enterprise)
...
2. **Configure basic information**:
   ...
   - **Subdomain**: Your unique URL (e.g., `acme.yourapp.com`)
...
**Setup process**:
1. **Install the Your SaaS Product app** from Teams App Store
...
**Bidirectional sync** between Jira issues and Your SaaS Product tasks:
...
<Callout kind="success">
  **Installation complete!** Your team is now ready to start collaborating effectively with Your SaaS Product.
</Callout>
...
4. **Browser cookies disabled**: Enable cookies for yourapp.com domain
