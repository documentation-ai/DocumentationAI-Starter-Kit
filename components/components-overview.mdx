...
description: "Comprehensive overview of all Documentation.AI components available for creating rich, interactive documentation."
---
...
- **Diagrams** - Technical diagrams and flowcharts (coming soon)
...
- **API Playground** - Interactive API testing (auto-generated from OpenAPI)
...
// Rich media with multiple formats
<Image 
...
<CodeGroup tabs="Getting Started,API Reference,Tutorials,Troubleshooting">
```jsx
...
<Callout kind="alert">
**Error**: `ECONNECT timeout after 5000ms`
</Callout>
