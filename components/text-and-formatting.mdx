...
description: "Master text formatting, typography, and content structure with Documentation.AI's text components."
---
...
1. **Account setup**
   1. Create your account at [signup page](https://yourapp.com/signup)
...
- [Official website](https://yourapp.com)
