---
title: Tables & Lists
description: "Organize and present structured data with tables, lists, and data presentation components in Documentation.AI."
---
...
1. **Create your account** at [yourapp.com/signup](https://yourapp.com/signup)
...
| `baseURL` | `string` | `""` | Base URL for all API requests | `"https://api.example.com"` |
