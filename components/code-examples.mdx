---
title: Code Examples
description: "Showcase code with syntax highlighting, multiple language support, and interactive features using Documentation.AI's code components."
---
...
class UserService {
    ...
    public function createUser($name, $email) {
        ...
        return json_decode(
            file_get_contents('https://api.example.com/users', false, $context),
            true
        );
    }
}
...
The `API_BASE_URL` environment variable should be set to `https://api.example.com` for production or `http://localhost:3000` for development.
